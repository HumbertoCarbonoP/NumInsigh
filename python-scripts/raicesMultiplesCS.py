...
def RaicesMultiplesCifrasSignificativas(func_str, func_deriv_str, x_inicial, tolerancia, max_iter):
    ...
    return raiz, iteraciones, xn, valores_f, errores

# Ejemplo de uso:
# raiz, iteraciones, valores_f, errores = RaicesMultiplesCifrasSignificativas(
