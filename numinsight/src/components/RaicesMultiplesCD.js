...
import RaicesMultiplesCDResult from './RaicesMultiples-Result copy';

function RaicesMultiplesCD() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await fetch('http://localhost:5000/raicesMultiplesCD', {
                method: 'POST',
                headers: {
    ...
    return (
        <div>
            ...
            <RaicesMultiplesCDResult result={resultData} />
        </div>
    );
}

export default RaicesMultiplesCD;
